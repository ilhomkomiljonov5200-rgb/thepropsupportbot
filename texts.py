...
"uz": {
    ...
    "ai_help": "💬 Live Chat",
    "ai_wait": "🔄 Admin siz bilan bog‘lanmoqda...\n⏳ Iltimos, biroz kuting",
    "ai_queue_wait": "🔄 Admin siz bilan bog‘lanmoqda...\n👥 Navbat raqamingiz: {position}\n⏳ Iltimos, biroz kuting",
    "ai_prompt": "✅ Admin bog‘landi\n📝 Iltimos savolingizni kiriting",
...
"ru": {
    ...
    "ai_help": "💬 Live Chat",
    "ai_wait": "🔄 Администратор подключается...\n⏳ Пожалуйста, немного подождите",
    "ai_queue_wait": "🔄 Администратор подключается...\n👥 Ваш номер в очереди: {position}\n⏳ Пожалуйста, немного подождите",
    "ai_prompt": "✅ Вы подключены к администратору\n📝 Теперь можете написать ваш вопрос",
...
"en": {
    ...
    "ai_help": "💬 Live Chat",
    "ai_wait": "🔄 Admin is connecting to you...\n⏳ Please wait a moment",
    "ai_queue_wait": "🔄 Admin is connecting to you...\n👥 Your queue position: {position}\n⏳ Please wait a moment",
    "ai_prompt": "✅ You are now connected to admin\n📝 You can send your question",
