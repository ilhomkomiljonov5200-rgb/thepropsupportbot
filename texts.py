...
"uz": {
    ...
    "ai_help": "💬 Live Chat",
    "ai_wait": "⏳ Iltimos admin javobini kuting",
    "ai_queue_wait": "⏳ Iltimos admin javobini kuting Sizning navbatingiz {position}",
    "ai_prompt": "✅ Admin bilan boglandingiz Savolingiz bolsa yozishingiz mumkin",
    "ai_answer_wait": "⏳ Iltimos, admin javobini kuting...",
    "ai_reply_pretty": "Admin javobi:\n\n{answer}",
    "ai_images_buffered": "🖼 Rasmlar qabul qilindi ({count}). Endi savolingizni yozing.",
    "ai_need_details": "Iltimos muammoni aniq yozing Muammoni to‘liq yozsangiz sizga yordam bera olaman 🙂",
    "ai_error": "❌ Javob berishda xatolik bo‘ldi. Keyinroq urinib ko‘ring.",
    "ai_error_reason": "❌ Xatolik: {reason}",
    "ai_disabled": "💬 Live Chat vaqtincha o‘chirildi.",
    "ai_end_chat_btn": "✅ Suhbatni yakunlash",
    "ai_rate_prompt": "Suhbatni baholang:",
    "ai_rate_thanks": "Suhbat uchun rahmat.",
    "ai_rate_inactive": "Baholash sessiyasi faol emas.",
...
"ru": {
    ...
    "ai_help": "💬 Live Chat",
    "ai_wait": "⏳ Пожалуйста ожидайте ответ администратора",
    "ai_queue_wait": "⏳ Пожалуйста ожидайте ответ администратора Ваша очередь {position}",
    "ai_prompt": "✅ Вы подключены к администратору Можете написать ваш вопрос",
    "ai_answer_wait": "⏳ Пожалуйста, ожидайте ответ администратора...",
    "ai_reply_pretty": "Ответ администратора:\n\n{answer}",
    "ai_images_buffered": "🖼 Изображения получены ({count}). Теперь напишите вопрос.",
    "ai_need_details": "Пожалуйста опишите проблему точнее Если напишете подробно я смогу помочь 🙂",
    "ai_error": "❌ Ошибка при ответе. Попробуйте позже.",
    "ai_error_reason": "❌ Ошибка: {reason}",
    "ai_disabled": "💬 Live Chat временно отключен.",
    "ai_end_chat_btn": "✅ Завершить чат",
    "ai_rate_prompt": "Оцените чат:",
    "ai_rate_thanks": "Спасибо за чат.",
    "ai_rate_inactive": "Сессия оценки не активна.",
...
"en": {
    ...
    "ai_help": "💬 Live Chat",
    "ai_wait": "⏳ Please wait for admin reply",
    "ai_queue_wait": "⏳ Please wait for admin reply Your queue position is {position}",
    "ai_prompt": "✅ You are connected to admin You can write your question",
    "ai_answer_wait": "⏳ Please wait for the admin reply...",
    "ai_reply_pretty": "Admin reply:\n\n{answer}",
    "ai_images_buffered": "🖼 Images received ({count}). Now type your question.",
    "ai_need_details": "Please describe the issue clearly If you write it in full detail I can help you 🙂",
    "ai_error": "❌ Failed to answer. Please try again later.",
    "ai_error_reason": "❌ Error: {reason}",
    "ai_disabled": "💬 Live Chat is temporarily disabled.",
    "ai_end_chat_btn": "✅ End chat",
    "ai_rate_prompt": "Rate this chat:",
    "ai_rate_thanks": "Thanks for the chat.",
    "ai_rate_inactive": "Rating session is not active.",
